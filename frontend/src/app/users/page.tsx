...
import { fetchAdminUsers, resetUserPassword, setUserActive } from "@/lib/api";
    ...
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="overflow-hidden rounded-3xl border border-[color:var(--border-muted)] bg-[color:var(--surface)] shadow-soft">
          <div className="grid grid-cols-[1.1fr_1fr_1fr_1fr_1.3fr] gap-4 border-b border-[color:var(--border-muted)] px-5 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-muted">
            ...
            <div className="divide-y divide-[color:var(--border-muted)]">
              {filteredUsers.map((user) => {
                ...
                return (
                  <div
                    key={user.id}
                    className="grid grid-cols-[1.1fr_1fr_1fr_1fr_1.3fr] gap-4 px-5 py-4 text-sm text-secondary"
                  >
                    <div>
